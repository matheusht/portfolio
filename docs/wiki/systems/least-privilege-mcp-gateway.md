---
title: "Least-Privilege MCP Gateway"
type: system
status: active
summary: "Architecting a secure intermediary to filter external Model Context Protocol requests."
source_of_truth:
...
# Least-Privilege MCP Gateway

**Scope:** Architecting a secure intermediary to filter external Model Context Protocol requests.  
