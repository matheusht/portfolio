---
title: "Deliberative Safety Consensus"
type: system
status: active
summary: "Multi-agent consensus architecture establishing robust validation steps before running tools."
source_of_truth:
...
# Deliberative Safety Consensus

**Scope:** Multi-agent consensus architecture establishing robust validation steps before running tools.  
