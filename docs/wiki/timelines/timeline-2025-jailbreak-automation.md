---
title: "Timeline: 2025 Jailbreak Automation"
type: timeline
status: active
summary: "Tracking the shift from manual prompt design to automated search algorithms in 2025."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Timeline: 2025 Jailbreak Automation

**Scope:** Tracking the shift from manual prompt design to automated search algorithms in 2025.  
