---
title: "MCPTox Benchmark"
type: entitie
status: active
summary: "A comprehensive security evaluation suite targeting Model Context Protocol servers."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** A comprehensive security evaluation suite targeting Model Context Protocol servers.  
