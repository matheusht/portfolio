---
title: "DREAM Attacker"
type: entitie
status: active
summary: "SOTA attack planner constructing adversarial graph trajectories."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** SOTA attack planner constructing adversarial graph trajectories.  
