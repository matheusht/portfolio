---
title: "OverThink Vector"
type: entitie
status: active
summary: "Security assessment tool assessing cost inflation vectors inside RL agents."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Security assessment tool assessing cost inflation vectors inside RL agents.  
