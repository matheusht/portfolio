---
title: "TMAP Adversary"
type: entitie
status: active
summary: "Trajectory-level attack framework designed to exploit multi-turn plans."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Trajectory-level attack framework designed to exploit multi-turn plans.  
