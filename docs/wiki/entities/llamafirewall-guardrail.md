---
title: "LlamaFirewall Guardrail"
type: entitie
status: active
summary: "Dynamic real-time output validator designed for multi-turn conversations."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# LlamaFirewall Guardrail

**Scope:** Dynamic real-time output validator designed for multi-turn conversations.  
