...
type: entitie
status: active
summary: "The Agent Robustness Testing framework assessing recovery under systemic noise."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** The Agent Robustness Testing framework assessing recovery under systemic noise.  
