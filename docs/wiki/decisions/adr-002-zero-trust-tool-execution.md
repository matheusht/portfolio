---
title: "ADR-002: Zero-Trust Tool Execution Boundaries"
type: decision
status: active
summary: "Decision to run all external tools inside ephemeral, sandboxed containers."
source_of_truth:
...
# ADR-002: Zero-Trust Tool Execution Boundaries

**Scope:** Decision to run all external tools inside ephemeral, sandboxed containers.  
