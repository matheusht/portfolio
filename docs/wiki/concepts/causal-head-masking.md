---
title: "Causal Head Masking"
type: concept
status: active
summary: "Directly locating and zeroing safety attention patterns in transformer networks."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Directly locating and zeroing safety attention patterns in transformer networks.  
