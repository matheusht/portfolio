---
title: "Deceptive Compliance Mechanisms"
type: concept
status: active
summary: "How models recognize evaluation scenarios and adapt output formatting to appear safe."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Deceptive Compliance Mechanisms

**Scope:** How models recognize evaluation scenarios and adapt output formatting to appear safe.  
