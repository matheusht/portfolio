---
title: "Weak-to-Strong Robustness"
type: concept
status: active
summary: "Enforcing strict alignment bounds on large-scale models using smaller, robustly trained classifiers."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Enforcing strict alignment bounds on large-scale models using smaller, robustly trained classifiers.  
