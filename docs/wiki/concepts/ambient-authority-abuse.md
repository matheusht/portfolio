...
type: concept
status: active
summary: "Leveraging high background privileges of automated agents to bypass security checks."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Leveraging high background privileges of automated agents to bypass security checks.  
