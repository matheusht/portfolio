...
type: concept
status: active
summary: "How small errors compound dynamically across recursive agent reasoning steps."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** How small errors compound dynamically across recursive agent reasoning steps.  
