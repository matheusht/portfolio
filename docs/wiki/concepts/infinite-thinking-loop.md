---
title: "Infinite Thinking Loop"
type: concept
status: active
summary: "Inducing infinite generation or processing sequences in LLMs to drain infrastructure resources."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Infinite Thinking Loop

**Scope:** Inducing infinite generation or processing sequences in LLMs to drain infrastructure resources.  
