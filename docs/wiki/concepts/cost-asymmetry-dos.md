---
title: "Cost Asymmetry DoS"
type: concept
status: active
summary: "Forcing expensive validation steps in LLM gateways with negligible attacker cost."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Forcing expensive validation steps in LLM gateways with negligible attacker cost.  
