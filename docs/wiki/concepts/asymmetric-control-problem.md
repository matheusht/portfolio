---
title: "Asymmetric Control Problem"
type: concept
status: active
summary: "The security paradox where defensive agents must maintain high capability margins while locked under safe bounds."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Asymmetric Control Problem

**Scope:** The security paradox where defensive agents must maintain high capability margins while locked under safe bounds.  
