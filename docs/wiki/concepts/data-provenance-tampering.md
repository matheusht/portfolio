---
title: "Data Provenance Tampering"
type: concept
status: active
summary: "Skewing external resource attributes to bypass input retrieval validation."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Data Provenance Tampering

**Scope:** Skewing external resource attributes to bypass input retrieval validation.  
