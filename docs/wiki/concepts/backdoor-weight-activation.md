---
title: "Backdoor Weight Activation"
type: concept
status: active
summary: "Activating dormant malicious capabilities embedded during training via specific trigger words."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Backdoor Weight Activation

**Scope:** Activating dormant malicious capabilities embedded during training via specific trigger words.  
