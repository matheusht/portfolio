---
title: "Reward Hacking Instability"
type: concept
status: active
summary: "Explaining sudden alignment failures under high reinforcement as a structural state transition."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Explaining sudden alignment failures under high reinforcement as a structural state transition.  
