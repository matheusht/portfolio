...
type: concept
status: active
summary: "Steering output vectors dynamically during inference without modifying base parameters."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Steering output vectors dynamically during inference without modifying base parameters.  
