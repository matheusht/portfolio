---
title: "Reasoning Inflation"
type: concept
status: active
summary: "Bloating computational costs of reasoning-centric models via artificial decoy logic puzzles."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Bloating computational costs of reasoning-centric models via artificial decoy logic puzzles.  
