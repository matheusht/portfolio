---
title: "Synthesized Guardrail Replay"
type: concept
status: active
summary: "Validating dynamically created security overrides by executing them against historical exploitation logs."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Synthesized Guardrail Replay

**Scope:** Validating dynamically created security overrides by executing them against historical exploitation logs.  
