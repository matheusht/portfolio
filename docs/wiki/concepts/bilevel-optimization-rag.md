---
title: "Bilevel Optimization for RAG"
type: concept
status: active
summary: "Formulating data poisoning attacks on RAG vector spaces mathematically using bilevel structures."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Bilevel Optimization for RAG

**Scope:** Formulating data poisoning attacks on RAG vector spaces mathematically using bilevel structures.  
