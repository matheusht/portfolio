---
title: "Inter-Agent Trust Degradation"
type: concept
status: active
summary: "Corrupting trust boundaries between autonomous workers to induce complete network freezes."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Inter-Agent Trust Degradation

**Scope:** Corrupting trust boundaries between autonomous workers to induce complete network freezes.  
