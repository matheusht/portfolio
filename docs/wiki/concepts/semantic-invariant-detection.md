---
title: "Semantic Invariant Detection"
type: concept
status: active
summary: "Interacting with models at structural concept layers rather than text boundaries."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
**Scope:** Interacting with models at structural concept layers rather than text boundaries.  
