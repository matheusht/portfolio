---
title: "Covert State Signaling"
type: concept
status: active
summary: "Passing encrypted instructions via low-entropy fields in shared database states."
source_of_truth:
  - docs/wiki/SCHEMA.md
...
# Covert State Signaling

**Scope:** Passing encrypted instructions via low-entropy fields in shared database states.  
