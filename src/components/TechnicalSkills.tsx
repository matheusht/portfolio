      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {skillCategories.map((category, idx) => (
            <div key={idx} className="bg-white/5 rounded-xl p-6 backdrop-blur-lg">
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-center mb-8 text-white">Badges</h3>
            ...
            {achievements.map((achievement, idx) => (
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-white">{achievement.platform}</h4>
                </div>
                <div className="space-y-2">
                  <p className="text-gray-300">{achievement.rank}</p>
